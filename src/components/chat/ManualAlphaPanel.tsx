...
interface Props {
  flow: {
    ...
    manual?: {
      retrieval?: { cards: { id: string; name: string; sourceIds: string[]; evidenceStrength: string }[]; latencyMs: number; tokenEstimate: number; limitation: string | null } | null;
